...
>(
  (
    ...
    const isMobile = useIsMobile(mobileBreakpoint, false);
...
const SidebarTrigger = React.forwardRef<
  React.ElementRef<typeof ButtonThin>,
  React.ComponentProps<typeof ButtonThin>
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ref={ref}
      data-sidebar="rail"
      aria-label="Sidebar Toggle Rail"
      tabIndex={-1}
      onClick={toggleSidebar}
      title="Sidebar Toggle Rail"
      className={cn(
