...
export function ThemeToggleTabList() {
  const { theme, setTheme } = useTheme();

  return (
    <div
      data-testid="theme-toggle-tabs"
      className="flex w-full items-center justify-between gap-2"
    >
      <div className="mx-0 flex h-fit w-full items-center justify-start gap-2 px-1.5 text-sm font-medium">
      ...
      <div dir="ltr" data-orientation="horizontal">
        <div
          ...
          className="flex h-fit items-center gap-0.5 overflow-hidden rounded-xl border bg-background p-0.5 text-muted-foreground"
          tabIndex={0}
        ...
        >
          <button
            ...
            className={cn(
              buttonThinVariants({ variant: 'ghost', size: 'sm' }),
              'relative h-7 rounded-lg px-2.5',
              theme === 'system' && 'bg-input/20 shadow-sm'
            )}
          >
          ...
          <button
            ...
            className={cn(
              buttonThinVariants({ variant: 'ghost', size: 'sm' }),
              'relative h-7 rounded-lg px-2.5',
              theme === 'light' && 'bg-input/20 shadow-sm'
            )}
          >
            <div className="relative z-10 flex items-center gap-1.5">
              <svg
          ...
          <button
            ...
            className={cn(
              buttonThinVariants({ variant: 'ghost', size: 'sm' }),
              'relative h-7 rounded-lg px-2.5',
              theme === 'dark' && 'bg-input/20 shadow-sm'
            )}
          >
            <div className="relative z-10 flex items-center gap-1.5">
              <svg
